...
import { getContactByIdAction } from "../../../../../store/actions/CustomerAction";
import { postChocolateOrder } from "../../../../../store/actions/OrderAction";
const flavors = {
  name: "",
  Amount: "",
};
const datas = {
  ...
  Bar_type: "",
  Customer_Material: "",
  Customer_Material_Weight: "lbs",
  active_ingredient: "",
  totalBar: "",
  packaging:'',
  status: "Pending",
  date: new Date(),
  types_Of_Bar: "Bags of Chocolates",
  Customer_Provider: "",
  flavorss: [
    {
      name: "Milk",
...
export const Order = () => {
  ...
  const [order, setOrder] = useState(datas);
  ...
  useEffect(() => [dispatch(getContactByIdAction(param.id))], []);
  useEffect(() => {
    setOrder({ ...order, ContactName: individualContact._id });
  }, [individualContact]);
  useEffect(() => {
  ...
  const routeChange = () => {
    history.push("/ecom-customerOrder");
  };
  const submitHandler = async (e) => {
    e.preventDefault();
    dispatch(postChocolateOrder(order, routeChange));
  };
  const editHandler = (e) => {
        ...
        <div className="card-body">
          <form onSubmit={submitHandler}>
                ...
                <div className="form-group row">
                  ...
                  <div className="col-lg-6">
                    <input
                      ...
                      value={individualContact.ContactName}
                      disabled
            ...
            <div className="table-responsive">
              <table class="table filtering-table table-responsive-lg d-content">
                <thead>
                  <tr>
