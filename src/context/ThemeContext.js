...
const ThemeContextProvider = (props) => {
	const [sideBarStyle, setSideBarStyle] = useState({ value: "overlay", label: "Overlay",});
 ...
 console.log("attr=>", setAttr)
  ...
  useEffect(() => {
    ...
    setWindowWidth(window.innerWidth);
		...
		window.innerWidth >= 301 && window.innerWidth < 1024
